...
import { Trophy, Users, Globe, Activity, ExternalLink, Github } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-auto md:grid-rows-2 gap-6 h-auto md:h-[600px]">
                    ...
                    <div className="col-span-1 md:col-span-2 row-span-2 bg-black rounded-3xl p-8 border border-white/10 flex flex-col justify-between group hover:border-sui-green/50 transition-all relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <h3 className="text-6xl md:text-8xl font-display font-bold text-white mb-2 tracking-tighter">$0.01</h3>
                            <p className="text-gray-400 text-lg uppercase tracking-widest font-mono">Projected Value Distribution</p>
                    ...
                    <div className="col-span-1 md:col-span-2 bg-sui-blue text-black rounded-3xl p-8 border border-white/10 flex items-center justify-between hover:scale-[1.01] transition-transform relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-6xl font-display font-bold tracking-tighter">No one</h3>
                            <p className="font-medium opacity-80 text-lg">Waitlisted Participants</p>
                        </div>
                ...
                <div className="mt-12 flex justify-center items-center gap-4 flex-wrap">
                    <p className="text-gray-600 text-xs font-mono uppercase tracking-widest">
                        Build by: <span className="text-white hover:text-sui-green cursor-pointer transition-colors">krypton</span>
                    </p>
                    <a
                        href="https://github.com/krypt0n123/Walottery"
                        target="_blank"
                        rel="noreferrer"
                        className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:text-sui-green hover:border-sui-green transition-colors"
